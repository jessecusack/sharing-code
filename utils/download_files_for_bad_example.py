...
save_to = os.path.join(save_dir, "analyse_data_v2.ipynb")
...
# +
with open(os.path.join(load_dir, "analyse_data_v2.m"), "r") as f:
    text = f.read()
...
# +
with open(os.path.join(load_dir, "analyse_data_v2.ipynb"), "r") as f:
    text = f.read()
